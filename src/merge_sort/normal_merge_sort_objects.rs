...
#[napi]
fn normal_merge_sort_objects_universal(
  ...
  _normal_merge_sort_objects_universal(&mut result, &mut index_list, &order_list);
}

fn _normal_merge_sort_objects_universal(
  ...
  _normal_merge_sort_objects_universal(&mut left_priority_list, &mut left_index_list, order_list);
  _normal_merge_sort_objects_universal(&mut right_priority_list, &mut right_index_list, order_list);
...
mod tests {
  ...
  fn test() {
    ...
    _normal_merge_sort_objects_universal(
      priority_list.as_mut_slice(),
      &mut index_list,
      &order_list,
    );
